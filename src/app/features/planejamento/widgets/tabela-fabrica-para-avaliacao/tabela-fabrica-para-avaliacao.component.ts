import { FabricaAvaliacaoStoreService } from '@/app/features/planejamento/services/FabricaAvaliacaoStore.service';
    ...
    columns: [
      {
        ...
        isButton: true,
        button: {
          command: (row) => this.router.navigate([`/planejamentos/RO/fabrica/${row.fabricaId}`]),
          icon: 'pi pi-eye',
          label: ''
        }
      },
