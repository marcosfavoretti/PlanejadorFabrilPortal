...
export async function virtualDateControllerHandleDateMethod(
  ...
  const res = await request<VirtualDateControllerHandleDateMethodMutationResponse, ResponseErrorConfig<Error>, unknown>({
    method: 'POST',
    url: getVirtualDateControllerHandleDateMethodUrl(param).toString(),
    ...requestConfig,
  })
  return res.data
}